...
const ValueProp = () => {
    return (
        <section className=" py-12 md:py-20 relative overflow-hidden" id="why-us">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="space-y-8 anim-section-reveal">
                        <div className="space-y-4">
                            ...
                            <h2 className="text-4xl md:text-7xl font-bold uppercase leading-[0.85] tracking-tighter text-black">
                                Excellence <br /> <span className="text-transparent" style={{ WebkitTextStroke: '1px var(--ivory-30)' }}>Reimagined</span>
                            </h2>
                        </div>
                        
                        <p className="text-black/60 text-lg leading-relaxed italic font-light tracking-wide max-w-xl">
                        ...
                        <div className="grid grid-cols-2 gap-8 pt-4 border-t border-black/5">
                            <div className="space-y-2">
                                <span className="text-gold text-[0.5rem] font-bold uppercase tracking-widest block">The Vision</span>
                                <p className="text-black/40 text-xs leading-relaxed uppercase font-bold tracking-tight">
                                    To provide a safe, discreet environment for both our companions and distinguished clientele.
                                </p>
                            </div>
                            <div className="space-y-2">
                                <span className="text-gold text-[0.5rem] font-bold uppercase tracking-widest block">The Standard</span>
                                <p className="text-black/40 text-xs leading-relaxed uppercase font-bold tracking-tight">
                        ...
                        <div className="pt-4">
                            <a href="#contact" className="group relative inline-block no-underline">
                                <span className="relative z-10 px-10 py-4 border border-black/10 text-black text-[0.6rem] font-bold uppercase tracking-[0.4em] group-hover:text-bg-primary transition-colors duration-500">
                                    Agency Protocols
                                </span>
                    ...
                    <div className="relative anim-section-reveal h-[500px] md:h-[600px]">
                        ...
                        <div className="absolute bottom-0 left-0 w-[55%] aspect-[3/4] border-4 border-ivory bg-bg-secondary z-10 shadow-2xl overflow-hidden translate-x-4 -translate-y-12">
                            <img 
                            ...
                            <div className="absolute top-4 right-4 w-12 h-12 rounded-full border border-gold/40 flex items-center justify-center backdrop-blur-md">
                                <span className="text-gold text-[0.5rem] font-bold">EST.12</span>
                            </div>
                        </div>

                        {/* Floating Text Element */}
                        <div className="absolute top-[10%] left-0 z-20 pointer-events-none opacity-[0.02]">
                            <span className="text-[10vw] font-bold text-black uppercase leading-none select-none">Prestige</span>
                        </div>
                    </div>
                </div>
            </div>
