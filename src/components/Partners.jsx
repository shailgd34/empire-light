...
const Partners = () => {
    return (
        <section className="bg-bg-primary py-12 md:py-16 border-t border-black/5" id="partners">
            <div className="container-wide">
                <div className="flex flex-col items-center justify-center space-y-8 anim-section-reveal">
                    ...
                    <div className="w-full max-w-4xl mx-auto p-4 md:p-8 bg-bg-secondary/40 border border-black/5 hover:border-gold/20 transition-all duration-1000 group overflow-hidden relative">
                        {/* Decorative Corners */}
