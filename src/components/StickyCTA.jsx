            ...
            <div className="bg-black/80 backdrop-blur-2xl border border-white/10 p-2 rounded-full flex items-center justify-between gap-4 shadow-2xl">
                <a href="tel:+447368428158" className="flex items-center gap-3 px-6 py-3 no-underline group">
                    ...
                    <div className="hidden md:block">
                        <span className="text-[0.45rem] uppercase tracking-widest text-white/40 block font-black">Secure Line</span>
                ...
                <div className="flex gap-2 p-1">
                    <a href="#profiles" className="px-6 py-3 bg-gold text-black text-[0.55rem] font-black uppercase tracking-widest rounded-full hover:bg-white transition-colors no-underline">
                        Book Now
                    </a>
                    <a href="#join" className="px-6 py-3 bg-white/5 border border-white/10 text-white text-[0.55rem] font-black uppercase tracking-widest rounded-full hover:bg-gold hover:text-black transition-all no-underline">
                        Join Us
                    </a>
                </div>
            </div>
