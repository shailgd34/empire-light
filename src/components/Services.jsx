...
const Services = () => {
    ...
    return (
        <section className="bg-black py-12 md:py-20 relative overflow-hidden" id="services">
            ...
            <div className="container-wide relative z-10">
                <div className="max-w-3xl mb-16 anim-section-reveal">
                    ...
                    <h2 className="text-4xl md:text-7xl font-black uppercase tracking-tighter leading-[0.85]">
                        The Empire <br /> <span className="text-transparent" style={{ WebkitTextStroke: '1px rgba(255,255,255,0.4)' }}>Service Mandate</span>
                    </h2>
                </div>

                <div className="grid grid-cols-1 lg:grid-cols-3 gap-1">
                    {services.map((service, idx) => (
                        <div key={idx} className="group relative p-10 md:p-14 bg-charcoal/40 border border-white/5 hover:bg-gold/5 transition-all duration-1000 overflow-hidden anim-section-reveal">
                            ...
                            <div className="relative z-10 space-y-8">
                                <span className="text-white/20 text-[0.5rem] font-black uppercase tracking-[0.5em] block group-hover:text-gold transition-colors">{service.tag}</span>
                                
                                <div className="space-y-4">
                                    <h3 className="text-3xl md:text-4xl font-black text-white uppercase tracking-tighter leading-none group-hover:italic transition-all duration-700">
                                        {service.title}
                                    </h3>
                                ...
                                <div className="pt-8">
                                    <a href="#contact" className="text-gold text-[0.5rem] font-black uppercase tracking-[0.5em] flex items-center gap-3 no-underline group-hover:gap-6 transition-all duration-500">
                            ...
                            <div className="absolute -bottom-10 -right-4 pointer-events-none opacity-[0.03] group-hover:opacity-[0.08] transition-opacity duration-1000">
                                <span className="text-[12rem] font-black text-white leading-none">0{idx + 1}</span>
                            </div>
                        </div>
                    ))}
                </div>
