                    ...
                    <div className="space-y-12">
                        <div className="space-y-6 ethos-reveal">
                            <div className="flex items-center gap-4">
                                ...
                                <span className="text-accent font-bold text-xs tracking-[0.4em] uppercase">Management Philosophy</span>
                            </div>
                            <h2 className="text-5xl md:text-8xl font-bold leading-[1.1] text-white">
                                The Empire <span className="italic text-transparent" style={{ WebkitTextStroke: '1.5px rgba(255,255,255,0.4)' }}>Commitment</span>
                            </h2>
                        </div>

                        <div className="space-y-8 ethos-reveal">
                            <p className="text-white/80 text-xl md:text-3xl font-bold leading-relaxed italic border-l-4 border-accent pl-10">
                                "We represent the best girls in Sheffield. We are 100% private and real."
                            </p>
                            <p className="text-white/40 text-lg md:text-xl font-medium leading-relaxed max-w-xl">
                                At Empire, we provide high-quality girls for outcall. All our girls are beautiful, real, and verified. We keep your booking 100% secret.
                            </p>
                        </div>

                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 pt-12 border-t border-white/10 ethos-reveal">
                            <div className="space-y-4">
                                <h4 className="text-accent text-sm font-bold uppercase tracking-widest">Real Girls</h4>
                                <p className="text-white/40 text-sm leading-relaxed">All girl photos are 100% real. No fake photos or time-wasters.</p>
                            </div>
                            <div className="space-y-4">
                                <h4 className="text-accent text-sm font-bold uppercase tracking-widest">Total Privacy</h4>
                                <p className="text-white/40 text-sm leading-relaxed">We respect your privacy. Everything is fast and discreet.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="relative anim-section-reveal group">
                        <div className="aspect-[4/5] overflow-hidden border border-white/10 relative shadow-[0_50px_100px_rgba(0,0,0,0.8)]">
                            ...
                            <div className="absolute bottom-12 right-12 text-right">
                                ...
                                <span className="text-accent text-2xl font-light italic tracking-widest" style={{ fontFamily: 'Cormorant Garamond, serif' }}>Empire Management</span>
                            </div>
                        </div>

                        {/* Floating Credential */}
                        <div className="absolute -bottom-12 -left-12 bg-accent p-10 hidden md:block shadow-2xl z-20 group-hover:translate-x-4 transition-transform duration-700">
