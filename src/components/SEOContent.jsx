...
const SEOContent = () => {
    ...
    return (
        <section className="bg-bg-primary py-24 md:py-32 border-t border-black/5" id="agency-details">
            <div className="container-wide">
                <div className="max-w-6xl mx-auto space-y-24 anim-section-reveal">
                    
                    {/* Main Section Heading */}
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-end">
                        <div className="lg:col-span-8 space-y-6">
                            <span className="text-gold font-bold text-sm tracking-[0.3em] uppercase block">Reliable Sheffield Agency</span>
                            <h2 className="text-4xl md:text-7xl font-bold text-black leading-tight">
                                Hire Escorts in Sheffield with an Agency <span className="italic text-transparent" style={{ WebkitTextStroke: '1px rgba(0,0,0,0.2)' }}>You Can Rely On</span>
                            </h2>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
                        {keyPoints.map((point, idx) => (
                            <div key={idx} className="space-y-6 group">
                                ...
                                <h3 className="text-xl font-bold text-black uppercase tracking-wider">{point.title}</h3>
                    ...
                    <div className="bg-bg-secondary p-12 md:p-20 shadow-xl border border-black/5 relative overflow-hidden">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 relative z-10">
                            <div className="space-y-8">
                                <h4 className="text-2xl font-bold text-black italic">Transparency & Trust</h4>
                                <p className="text-black/70 text-lg leading-relaxed font-medium italic border-l-4 border-gold pl-8">
                            ...
                            <div className="space-y-8">
                                <h4 className="text-2xl font-bold text-black italic">Rapid Outcall Service</h4>
                                <p className="text-black/60 text-base leading-relaxed">
                                ...
                                <div className="pt-8 grid grid-cols-2 gap-8">
                                    <div className="space-y-2">
                                        <span className="text-black font-bold text-3xl block">24/7</span>
                                        <span className="text-black/40 text-xs font-bold uppercase tracking-widest">Available</span>
                                    </div>
                                    <div className="space-y-2">
                                        <span className="text-black font-bold text-3xl block">100%</span>
                                        <span className="text-black/40 text-xs font-bold uppercase tracking-widest">Discreet</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="space-y-8">
                        <div className="flex items-center gap-4">
                            <span className="text-black/20 text-xs font-bold uppercase tracking-[0.4em]">Regional Hubs & Coverage</span>
                        ...
                        <div className="flex flex-wrap gap-x-10 gap-y-4">
                            {[
                                ...
                                <span key={tag} className="text-[0.65rem] font-bold text-black/30 hover:text-gold transition-colors uppercase tracking-widest cursor-default">
                                    {tag}
                                </span>
                            ))}
                        </div>
                    ...
                    <div className="text-center pt-8">
                        <p className="text-black/30 text-[0.6rem] font-bold tracking-[0.2em] uppercase">
